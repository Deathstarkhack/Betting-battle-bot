...
start_button = InlineKeyboardButton("Start Battle", callback_data=f"begin_{user1.id}{user2.id}{amount}")
...
, uid1, uid2, amount = query.data.split("")
...
keyboard = [
[
InlineKeyboardButton(f"Win: @{u1['username']}", callback_data=f"win_{uid1}{uid2}{amount}"),
InlineKeyboardButton("Draw", callback_data=f"draw_{uid1}{uid2}{amount}"),
InlineKeyboardButton(f"Win: @{u2['username']}", callback_data=f"win_{uid2}{uid1}{amount}"),
]
]
